    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
                ...
                <p class="lead"> ¡Bienvenidos al emocionante mundo del
                    "Posicionamiento Digital de Marcas"! En la era digital, la visibilidad en
                    línea es crucial para el éxito de cualquier marca. Este entrenamiento ha sido
                    diseñado para ayudar a profesionales del marketing, emprendedores y
                    entusiastas de las redes sociales a comprender los conceptos y
                    estrategias fundamentales necesarios para posicionar una marca de
                    manera efectiva en el entorno digital altamente competitivo de hoy en
                    día.</p>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-sm-pull-6  col-sm-6">
                <div class="row">
                    ...
                    <p class="lead">El entrenamiento de "Posicionamiento Digital de Marcas" está dirigido a
                        profesionales del marketing, emprendedores, gerentes, estudiantes y
                        cualquier persona interesada en mejorar sus habilidades en el ámbito
                        digital, brindando las herramientas y estrategias necesarias para
                        comprender y aplicar con éxito el posicionamiento de marcas en el
                        competitivo entorno en línea.</p>
                </div>
            </div>
        </div>
...
<div class="container">
    <h1>Valor</h1>
    <h3>$300.000</h3>
    <a href="https://mpago.li/2XdftP1" class="CartBtn" target="_blank">
...
<div id="service" class="service">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <div class="titlepage">
                    <h2><strong class="yellow">Contenidos</strong><br>Posicionamiento digital de marcas</h2>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div id="ho_color" class="service_box">
                    ...
                    <p>1.3. Definición de objetivos de posicionamiento digital.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div id="ho_color" class="service_box">
                    ...
                    <p>2.3. Técnicas avanzadas de SEO y prácticas recomendadas.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div id="ho_color" class="service_box">
                    ...
                    <p>3.3. Gestión de la comunidad y estrategias de participación.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div id="ho_color" class="service_box">
                    ...
                    <p>4.3. Distribución y promoción de contenido.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div id="ho_color" class="service_box">
                    ...
                    <p>5.3. Ajuste y optimización de estrategias de posicionamiento.</p>
                </div>
            </div>
        </div>
    </div>
