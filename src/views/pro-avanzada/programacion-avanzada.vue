...
<section class="hero_section ">
    <div class="hero-container container">
        ...
        <div class="hero_img-container">
            <div>
                <img src="@/assets/Imagenes/programacion-avanzada/imagenes/hero.png" alt="" class="img-fluid">
            </div>
        </div>
    </div>
</section>
...
<style scoped>
@import '../pro-avanzada/css/estilo.css';
@import '../pro-avanzada/css/responsive.css';
