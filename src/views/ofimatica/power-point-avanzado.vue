...
<div class="container">
    <h1>Valor</h1>
    <h3>$300.000</h3>
    <a href="https://mpago.li/1YGjv4w" class="CartBtn" target="_blank">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div id="ho_color" class="service_box">
                    ...
                    <p>1.2. Formato de Texto..</p>
                    <p>1.3. Formato de Párrafo.</p>
                    <p>1.4. La “Minibarra” de
                        Herramientas.</p>
                    <p>1.5. WordArt.</p>
                    <p>1.6. Edición de Texto..</p>
                    <p>1.7. Deshacer y Rehacer
                        Operaciones.</p>
                    <p>1.8. Mejora y Corrección del
                        Texto.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
