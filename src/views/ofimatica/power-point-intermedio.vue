...
<div class="container">
    <h1>Valor</h1>
    <h3>$300.000</h3>
    <a href="https://mpago.li/2BtbTzs" class="CartBtn" target="_blank">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div id="ho_color" class="service_box">
                    ...
                    <p>1.1.¿Cuál es la interfaz de
                        Power Point?.</p>
                    <p>1.2. Estructura de la
                        interfaz de Power Point.</p>
                    <p>1.3. Personalización de la
                        cinta de opciones.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
            ...
            <div class="col-md-4 col-sm-6">
                <div id="ho_color" class="service_box">
                    ...
                    <p>3.2. Combinación de
                        colores.</p>
                    <p>3.3. Fuentes.</p>
                    <p>3.4. Formato de fondos.</p>
                    <p>3.5. Numeración de
                        diapositivas. </p>
                </div>
            </div>
